 ...
 */
package org.wildfly.extras.micrometer.metrics.jmx;
...
import org.wildfly.extras.micrometer.metrics.MetricMetadata;
import org.wildfly.extras.micrometer.metrics.WildFlyMetric;
...
public class JmxMetricCollector {
    ...
    public void init() throws IOException {
        register("jmx-metrics.properties");
    }


    private void register(String propertiesFile) throws IOException {
    ...
    void register(JmxMetricMetadata metadata) {
        ...
        registry.addMetric(metric, metadata);
    }
